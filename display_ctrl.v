module display_ctrl(
    ...
    assign mode_alarm     = ~mode_state[2] & mode_state[1] & ~mode_state[0];
    assign mode_countdown = mode_state[2] & ~mode_state[1] & ~mode_state[0];
    assign mode_other     = (~mode_state[2] & mode_state[1] & mode_state[0]) |
                            (mode_state[2] & ~mode_state[1] & mode_state[0]);
    ...
    assign sec_ten_disp_bcd = mode_alarm ? {3'b000, alarm_enable} :
                              mode_countdown ? countdown_sec_ten_bcd :
                              sec_ten_time_bcd;
    assign min_unit_disp_bcd = mode_alarm ? alarm_min_unit_bcd :
                               mode_countdown ? countdown_min_unit_bcd :
                               min_unit_time_bcd;
    assign min_ten_disp_bcd = mode_alarm ? alarm_min_ten_bcd :
                              mode_countdown ? countdown_min_ten_bcd :
                              min_ten_time_bcd;
    assign hour_unit_disp_bcd = mode_alarm ? alarm_hour_unit_bcd :
                                mode_countdown ? 4'd0 :
                                hour_unit_time_bcd;
    assign hour_ten_disp_bcd = mode_alarm ? alarm_hour_ten_bcd :
                               mode_countdown ? 4'd0 :
                               hour_ten_time_bcd;
endmodule
